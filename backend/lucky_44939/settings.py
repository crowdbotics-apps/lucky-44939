"""
Django settings for lucky_44939 project.
...
WSGI_APPLICATION = 'lucky_44939.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lucky_44939 API",
    "DESCRIPTION": "API documentation for lucky_44939 App",
    "VERSION": "v1",
}
